...
namespace bison {
#ifndef __BISON__SSIZE_DEFINED_T
#define __BISON__SSIZE_DEFINED_T
using __bison__ssize_t = std::ptrdiff_t;
#endif
using ssize_t = __bison__ssize_t;
...
#else
template <class T> constexpr bool is_wide_character_v = is_any_of_v<std::remove_cv_t<T>, char16_t>;
#endif
